...
/**
* @author ikaddoura edited by Erik (altitudeflight)
*/

public final class RunBerlinScenarioHomework1 {

	private static final Logger log = Logger.getLogger(RunBerlinScenarioHomework1.class );
	...
	public static void main(String[] args) {
		...
		if ( args.length==0 ) {
			args = new String[] {"scenarios/berlin-v5.5-1pct/input/berlin-v5.5-1pct.config.xml"}  ; //Erik: changed to 1pct-input-config
		}
