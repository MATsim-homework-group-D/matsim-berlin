...
public final class RunBerlinScenario_U1Extension_WithoutKantstrasse {

	private static final Logger log = Logger.getLogger(RunBerlinScenario_U1Extension_WithoutKantstrasse.class );
